...
public final class Bitstream implements BitstreamErrors
{
  ...
  //private int				last_frame_number;
	...
	public boolean isSyncCurrentPosition(int syncmode) throws BitstreamException
	{
		...
		if(read==2 && syncbuf[0]==0x0d && syncbuf[1]==0x0a){
			Log.d("wangpeng","realy end!!!!!!!!!!!!!!!!");
			return true;
		}
  ...
  public int get_bits(int number_of_bits)
  {
	...
	{		
		...
		totalBytesRead1+=nRead;
		Log.d("wangpeng", "readFully:"+String.valueOf(nRead)+" totalBytesRead1:"+totalBytesRead1);
		return nRead;
	}
		...
		throws BitstreamException
	{
		...
		totalBytesRead1+=totalBytesRead;
		Log.d("wangpeng", "totalBytesRead:"+String.valueOf(totalBytesRead)+" "+ Arrays.toString(b)+" totalBytesRead1:"+totalBytesRead1);
